        ...
        <div className="app-shell">
            <section className="hero-panel">
                <div className="hero-copy">
                    ...
                    <h1>Plan your salary and categories with confidence</h1>
                    <p>
                        Change salary and percentages independently, then save
                        once your total reaches 100%.
                    </p>
                </div>
                <div className="hero-stats">
                    ...
                    <div className="stat-card">
                        ...
                        <strong>
                            {budget
                                ? `${Math.round(budget.savings + budget.offering + budget.utilities + budget.relationship + budget.relationshipSavings)}%`
                                : "—"}
                        </strong>
                    </div>
                </div>
            ...
            <main className="budget-layout">
                <section className="budget-form card">
                    <div className="section-header">
                        <div>
                            ...
                            <p>
                                Update salary and category allocations
                                independently, then save when the total is
                                exactly 100%.
                            </p>
                        </div>
                        <div
                            className={`total-pill ${totalValid ? "valid" : "invalid"}`}
                        >
                    ...
                    <div className="budget-meter">
                        ...
                        <div className="meter-meta">
                            ...
                            <span
                                className={
                                    totalValid ? "meter-ok" : "meter-warning"
                                }
                            >
                                {totalValid
                                    ? "Perfect!"
                ...
                <aside className="budget-preview card">
                    ...
                    <div className="preview-footer">
                        ...
                        <strong>
                            {totalValid ? "Balanced" : "Needs adjustment"}
                        </strong>
                    </div>
                </aside>
            </main>
